...
19 Jul | [6.4](https://open.kattis.com/problems/digitsum) | [digitsum.rs](rust/digitsum/src/main.rs) | Sum digits in a large range of numbers [+](notes/Digit Sum.md)
...
17 Jun | [4.8](https://open.kattis.com/problems/targetpractice) | [targetpractice.rs](rust/targetpractice/src/main.rs) | Draw two lines through all points if possible [+](notes/Target Practice.md)
14 Jun | [5.0](https://open.kattis.com/problems/romanholidays) | [romanholidays.rs](rust/romanholidays/src/main.rs) | Locate a roman number in the ordered list of them [+](notes/Roman Holidays.md)
...
29 May | [4.9](https://open.kattis.com/problems/addemup) | [addemup.rs](rust/addemup/src/main.rs) | Find two cards that sum to x, some can rotate [+](notes/Add 'Em Up!.md)
